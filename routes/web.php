...
Route::get('/upload-pdf-image', [EditorController::class, 'showUploadForm'])->name('uploadPdfImage');
Route::post('/process-pdf-overlay', [EditorController::class, 'processPdfAndOverlay'])->name('processPdfAndOverlay');
Route::post('/overlay-image', [EditorController::class, 'overlayImage'])->name('overlayImage');
